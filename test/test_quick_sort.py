...
def test_list_len_50(benchmark, list_len_50, ):
    results = benchmark.pedantic(sorting_algos.quick_sort, args=(list_len_50,), iterations=2, rounds=5)
...
def test_list_len_250(benchmark, list_len_250, ):
    results = benchmark.pedantic(sorting_algos.quick_sort, args=(list_len_250,), iterations=2, rounds=5)
...
def test_list_len_750(benchmark, list_len_750, ):
    results = benchmark.pedantic(sorting_algos.quick_sort, args=(list_len_750,), iterations=2, rounds=5)
...
def test_list_len_2050(benchmark, list_len_2050, ):
    results = benchmark.pedantic(sorting_algos.quick_sort, args=(list_len_2050,), iterations=2, rounds=5)
    sorted(list_len_2050) == results

def test_list_len_5000(benchmark, list_len_5000, ):
    results = benchmark.pedantic(sorting_algos.quick_sort, args=(list_len_5000,), iterations=2, rounds=5)
